{
  ...
  nokogiri = {
    ...
    targets = [{
      remotes = ["https://rubygems.org"];
      sha256 = "0zfi8a69cp0g5jsx0bb0n4xqs508ch87mdz3hxajmhxl9mpph8mw";
      ...
      remotes = ["https://rubygems.org"];
      sha256 = "13f5xy03jgw6mxw5l67lngz6m8z17s2jwyhm50x1qrw7s8yicvv5";
      target = "x64-mingw-ucrt";
      targetCPU = "x64";
      targetOS = "mingw";
      type = "gem";
    } {
      remotes = ["https://rubygems.org"];
      sha256 = "146gn7mwz58mqh6hcqskppzqxpx1zn67jxihwf9s8bq0iianhcjx";
      target = "arm64-darwin";
      targetCPU = "arm64";
      targetOS = "darwin";
      type = "gem";
      ...
      remotes = ["https://rubygems.org"];
      sha256 = "1jz82a29khp0hqc7j7p0644l2hywna8b9ymn4l1116ml847378s7";
      target = "x86_64-linux";
      targetCPU = "x86_64";
      targetOS = "linux";
      type = "gem";
  ...
  pg = {
    ...
    targets = [{
      remotes = ["https://rubygems.org"];
      sha256 = "0ash4y84nvazphwmaxr0g2j5s3p8p0s50ispbsh2jhqrf5602352";
      target = "x64-mingw-ucrt";
      targetCPU = "x64";
      targetOS = "mingw";
      type = "gem";
  ...
  sqlite3 = {
    ...
    targets = [{
      ...
      remotes = ["https://rubygems.org"];
      sha256 = "0i8za4iqa6wqfwfcah6rhpw8al2117h87xxna7k941pvwiaa4143";
      target = "x64-mingw-ucrt";
      targetCPU = "x64";
      targetOS = "mingw";
      type = "gem";
